(function (blocks, element, blockEditor, components, data) {
  ...
  registerBlockType('jaspi/featured-products', {
    title: 'Jaspi Featured Products',
    icon: 'products',
    category: 'widgets',
    keywords: ['products', 'featured', 'woocommerce', 'jaspi'],
    attributes: {
      title: {
        type: 'string',
    ...
    edit: function (props) {
      ...
      return el('div', { className: 'jaspi-featured-products-editor' }, [
        ...
        el('div', { className: 'jaspi-featured-products-preview' }, [
          el('h2', { 
            style: { 
              textAlign: 'center', 
              color: '#FF1654', 
