(function (blocks, element, blockEditor, components, data) {
  ...
  registerBlockType('jaspi/product-categories', {
    title: 'JASPI Product Categories',
    icon: 'grid-view',
    category: 'widgets',
    attributes: {
      selectedCategories: {
    ...
    edit: function (props) {
      ...
      return el(
        'div',
        { className: 'jaspi-product-categories-editor' },
        [
          el(
            InspectorControls,
            { key: 'inspector' },
          ...
          el(
            ...
            [
              el('h3', { style: { textAlign: 'center', color: '#ff0000' } }, attributes.title),
              el(
                'div',
              ...
              attributes.subtitle && el('h3', { style: { textAlign: 'center', color: '#ff0000', marginTop: '30px' } }, attributes.subtitle)
            ]
          )
        ]
      );
